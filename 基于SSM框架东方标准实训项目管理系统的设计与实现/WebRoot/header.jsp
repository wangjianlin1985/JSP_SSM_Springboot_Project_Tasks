    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Group/frontlist">分组</a></li> 
                <!-- 
                <li><a href="<%=basePath %>GroupStudent/frontlist">分组成员</a></li>
                <li><a href="<%=basePath %>Student/frontlist">学员</a></li>
                 -->
                <li><a href="<%=basePath %>Project/frontlist">项目</a></li>
                <li><a href="<%=basePath %>ResourceInfo/frontlist">资源</a></li>
                <li><a href="<%=basePath %>Journal/frontlist">项目日志</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>ResourceInfo/resourceInfo_frontStuAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;上传资源</a></li>
                        <li><a href="<%=basePath %>ResourceInfo/stuFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我上传的资源</a></li>
                        <li><a href="<%=basePath %>Journal/journal_stuFrontAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;发布日志</a></li>
                        <li><a href="<%=basePath %>Journal/stuFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我发布的日志</a></li>
                        <li><a href="<%=basePath %>Student/student_frontModify.jsp?studentNumber=<%=session.getAttribute("user_name") %>"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;修改个人信息</a></li>
                    </ul>
                </li>
