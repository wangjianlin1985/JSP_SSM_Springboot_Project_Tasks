...
public class StudentService {
    ...
    /*按照查询条件分页查询学员记录*/
    public ArrayList<Student> queryStudent(String studentNumber,ClassInfo classObj,String name,String birthDate,String telephone,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Student> queryStudent(String studentNumber,ClassInfo classObj,String name,String birthDate,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!studentNumber.equals("")) where = where + " and t_student.studentNumber like '%" + studentNumber + "%'";
    	if(null != classObj &&  classObj.getClassNo() != null && !classObj.getClassNo().equals(""))  where += " and t_student.classObj='" + classObj.getClassNo() + "'";
    	if(!name.equals("")) where = where + " and t_student.name like '%" + name + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String studentNumber,ClassInfo classObj,String name,String birthDate,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!studentNumber.equals("")) where = where + " and t_student.studentNumber like '%" + studentNumber + "%'";
    	if(null != classObj &&  classObj.getClassNo() != null && !classObj.getClassNo().equals(""))  where += " and t_student.classObj='" + classObj.getClassNo() + "'";
    	if(!name.equals("")) where = where + " and t_student.name like '%" + name + "%'";
