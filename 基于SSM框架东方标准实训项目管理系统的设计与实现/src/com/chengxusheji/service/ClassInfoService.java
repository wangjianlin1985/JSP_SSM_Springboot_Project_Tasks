...
public class ClassInfoService {
    ...
    /*按照查询条件分页查询班级记录*/
    public ArrayList<ClassInfo> queryClassInfo(String classNo,String className,String bornDate,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<ClassInfo> queryClassInfo(String classNo,String className,String bornDate) throws Exception  { 
     	String where = "where 1=1";
    	if(!classNo.equals("")) where = where + " and t_classInfo.classNo like '%" + classNo + "%'";
    	if(!className.equals("")) where = where + " and t_classInfo.className like '%" + className + "%'";
    	if(!bornDate.equals("")) where = where + " and t_classInfo.bornDate like '%" + bornDate + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String classNo,String className,String bornDate) throws Exception {
     	String where = "where 1=1";
    	if(!classNo.equals("")) where = where + " and t_classInfo.classNo like '%" + classNo + "%'";
    	if(!className.equals("")) where = where + " and t_classInfo.className like '%" + className + "%'";
    	if(!bornDate.equals("")) where = where + " and t_classInfo.bornDate like '%" + bornDate + "%'";
